  ...
  return (
    <div className="App">
      ...
      <div style={{ display: "block", flexDirection: "column" }}>
        Only if you are (1) late on your business-line or collateralized debt, and
        the lender tacks on more than they estimated they would need to take on
        this risk forever (depreciation-no-give-backsies), or scalping markets with no utility in assets or cash (2) are you usurping a
      ...
      <span>
        ...
        not numbers by bets beyond escrow & involving others' marginal benefits
        or utility expended as cost
      </span>
      <br />
      ...
      <span>
        ...
        time, it is price-fixing as a business can wait for customers to deliver
        return, while an individual will have to charge their patrons to have
        enough to buy food, health & shelter & the partner (really colonizer in
        this situation)
        {/**
